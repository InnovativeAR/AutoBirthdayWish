...
GMAIL_ID = 'augureji2003@gmail.com'
GMAIL_PWD = 'nwvlwyyxxzuvwftb'
...
if __name__ == "__main__":
    hostname = "localhost"  
    password = "Augustine$2003"
    try:
        # create engine to connect to MySQL database using SQLAlchemy
        engine = create_engine(f'mysql+mysqlconnector://augu:{password}@{hostname}/wish')
